...
const translations = {
    ...
    'api.gemini_paid': { pt: 'Chave Gemini (Paga)', en: 'Gemini API Key (Paid)' },
    'api.gemini_free': { pt: 'Chave Gemini (Gratuita)', en: 'Gemini API Key (Free)' },
    'api.ai_studio': { pt: 'Chave AI Studio', en: 'AI Studio API Key' },
    'api.ai_studio_hint': { pt: 'Para workers Gemma 3 (tier gratuito)', en: 'For Gemma 3 workers (free tier)' },
    ...
    'api.memory_manager_desc': { pt: 'Chave dedicada para workers de memória', en: 'Dedicated key for memory processing workers' },
    'api.memory_manager_key': { pt: 'Chave do Gerenciador', en: 'Memory Manager Key' },
    'api.memory_manager_hint': { pt: 'Usa a chave Gemini gratuita se vazio', en: 'Falls back to Gemini free key if empty' },
    ...
    'api.deepinfra_hint': { pt: 'Fallback para workers Gemma 3', en: 'Fallback for Gemma 3 workers' },
    ...
    'chat.google_label': { pt: 'Gemma 27B', en: 'Gemma 27B' },
    ...
    'chat.japanese': { pt: 'Modo japonês', en: 'Japanese teaching mode' },
    'chat.japanese_desc': { pt: 'Ativar ensino de japonês N5 nas conversas', en: 'Enable N5-level Japanese teaching in conversations' },
    ...
    'agent.available_workers_desc': { pt: '8 workers especializados para decomposição de tarefas', en: '8 specialized workers for task decomposition' },
